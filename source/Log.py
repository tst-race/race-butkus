...
def logDebug(message):
    ...
    """
    RaceLog.logDebug("PluginButkusEncoding", message, "")
...
def logInfo(message):
    ...
    """
    RaceLog.logInfo("PluginButkusEncoding", message, "")
...
def logWarning(message):
    ...
    """
    RaceLog.logWarning("PluginButkusEncoding", message, "")
...
def logError(message):
    ...
    """
    RaceLog.logError("PluginButkusEncoding", message, "")
